...
public class ActivityKhaiVi extends AppCompatActivity {
    FirebaseDatabase data;
    DatabaseReference data2;
    List<KhaiVi> list = new ArrayList<KhaiVi>();
    ListView lvDanhSach;
    AdapterKhaiVi adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvDanhSach = findViewById(R.id.list_danhSachKhaiVi);
        edtSearch = findViewById(R.id.edt_searchKhaiVi);
        imgBack = findViewById(R.id.back_KhaiVi);
        imgGioHang = findViewById(R.id.image_shopKhaiVi);
        imgLoad = findViewById(R.id.img_loadKhaiVi);

        data = FirebaseDatabase.getInstance();
        data2 = data.getReference("KHAIVI");
        //LOAD ẢNH
        loadData();
        //SEARCH
        search();
    ...
    public void loadData(){
        data2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot children : convert){
                    KhaiVi khaiVi =children.getValue(KhaiVi.class);
                    list.add(khaiVi);
        ...
        adapter = new AdapterKhaiVi(ActivityKhaiVi.this,list);
    ...
    public void search(){
        ...
        adapter2 = new ArrayAdapter(ActivityKhaiVi.this, android.R.layout.simple_dropdown_item_1line,name);
    ...
    public void gioHang(){
        imgGioHang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ActivityKhaiVi.this,ActivityGioHang.class);
